...
function IFLogo({ compact }: { compact?: boolean }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", lineHeight: 1 }}>
      <div style={{ position: "relative", width: compact ? 30 : 40, height: compact ? 30 : 40 }}>
        <svg width={compact ? 30 : 40} height={compact ? 30 : 40} viewBox="0 0 40 40" style={{ position: "absolute", inset: 0 }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Cormorant Garamond", fontSize: compact ? 11 : 15, color: "#F2D28B", fontWeight: 500 }}>IF</div>
      </div>
      {!compact && (
...
export default function Header() {
  ...
  return (
    <header style={{ position: "fixed", top: isMobile ? 12 : 20, left: 0, right: 0, zIndex: 100, display: "flex", justifyContent: "center", pointerEvents: "none" }}>
      <nav
        style={{
          pointerEvents: "auto",
          display: "flex",
          ...
          padding: isMobile ? "0.4rem 0.6rem" : "0.6rem 1.25rem",
          maxWidth: "94vw",
          borderRadius: 999,
      ...
      >
        ...
        <span style={{ width: 1, height: 24, background: "rgba(255,255,255,0.1)" }} />
        <a href="#catalog" className="btn-outline" style={{ fontSize: isMobile ? 9 : 10, padding: isMobile ? "0.45rem 0.8rem" : "0.55rem 1.15rem", whiteSpace: "nowrap" }}>Shop Now</a>
      </nav>
    </header>
  );
}